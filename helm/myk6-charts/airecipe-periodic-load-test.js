...
export function demoRequest() {
  ...
  // Service ClusterIP 사용 (클러스터 내부에서 실행 시)
  let url = `http://${serviceName}:${servicePort}${endpoint}`;
  
  // 또는 NodePort 사용 (클러스터 외부에서 실행 시)
  // 노드 IP를 실제 값으로 변경하세요
  // const nodeIP = 'YOUR_NODE_IP';  // 예: '192.168.1.100'
